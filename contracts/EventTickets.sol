...
contract EventTickets {
    ...
    */
    event LogBuyTickets(address indexed buyer, uint indexed ticketsPurchased);
    event LogGetRefund(address indexed refundRequester, uint indexed ticketsRefunded);
    ...
    */
    function endSale() public isOwner {
        ...
        uint totalAmount = myEvent.sales*TICKET_PRICE;
        owner.transfer(totalAmount);
        emit LogEndSale(owner, totalAmount);
    }
}
